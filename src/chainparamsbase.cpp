...
/**
 * Port numbers for incoming Tor connections (8344, 18344, 38344, 48344, 18455) have
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 8342);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 18342);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 48342);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 38342);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 18453);
    }
    assert(false);
}
