    ...
    const std::string& out_ciphertext_endswith_hex)
{
    ...
    BOOST_TEST_MESSAGE("*_*_*_*_*_*_*_*_*_*_*_*_*_");
    // Load keys
    CKey key;
    ...
    BOOST_TEST_MESSAGE("*_*_*_*_*_*_*_*_*_*_*_*_*_*_ out_session_id: " << HexStr(Span{out_session_id}));
    BOOST_TEST_MESSAGE("*_*_*_*_*_*_*_*_*_*_* cipher.GetSessionID(): " << HexStr(cipher.GetSessionID()));
    BOOST_TEST_MESSAGE("*_*_*_*_*_*_*_*_*_*_*_*_*_ mid_send_garbage: " << HexStr(Span{mid_send_garbage}));
    BOOST_TEST_MESSAGE("*_*_*_*_*_cipher.GetSendGarbageTerminator(): " << HexStr(cipher.GetSendGarbageTerminator()));
    BOOST_TEST_MESSAGE("*_*_*_*_*_*_*_*_*_*_*_*_*_ mid_recv_garbage: " << HexStr(Span{mid_recv_garbage}));
    BOOST_TEST_MESSAGE("*_*_*_*_*_*_*_GetReceiveGarbageTerminator(): " << HexStr(cipher.GetReceiveGarbageTerminator()));
    ...
    if (!out_ciphertext.empty()) {
       BOOST_TEST_MESSAGE("*_*_*_*_*_*_*_*_*_*_*_*_*_ out_ciphertext: " << HexStr(out_ciphertext));
       BOOST_TEST_MESSAGE("*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_ ciphertext: " << HexStr(ciphertext));
       BOOST_CHECK(out_ciphertext == ciphertext);
    } else {
        BOOST_TEST_MESSAGE("*_*_*_*_*_*_*_*_*_*_*_*_*_ out_ciphertext_endswith: " << HexStr(Span{out_ciphertext_endswith}));
        BOOST_TEST_MESSAGE("*_*_*_*_*_*_*_*_*_*_ut_ciphertext_endswith.size()): " << HexStr(Span{ciphertext}.last(out_ciphertext_endswith.size())));
...
BOOST_AUTO_TEST_CASE(packet_test_vectors) {
    ...
    TestBIP324PacketVector(
        ...
        "",
        false,
        "7aa42e80f8548844aa4d10d110ffe43f",
        "657b9e6194aaf4559ab2c9efd838edc6",
        "72f7c51cd9ef358f912c20b59fcd161faa13a2619eaa2db8ebba6121d79fdb02",
        "453bce27b3bdba7b86a448aa9591feb9ff354ff45b",
        "");
    TestBIP324PacketVector(
        999,
        ...
        "",
        false,
        "39430e7e64cccc79c4f3697f851196b2",
        "d7cee4ff2445f62044fcb415f882faf6",
        "3a8988d1307483f396c82c5ef1860aa611d88ad716583e6385ceec64f8c0864d",
        "db1aa4cac39048db25ad5d3fd4975af4a99905aff2236b22d088760bf37e63a9a62de9b67e",
        "");
    TestBIP324PacketVector(
        0,
        ...
        false,
        "cb49b87acfc26d53f263054d1d165a73",
        "426870279aaa25afac39c2bdedf60026",
        "0006b4ec7c172142fa69844ba67f7cadadc721e6d356b76be699b944cc17e0b6",
        "2b0c134f7ddf79c54c514367cc5d3016378c1d3a3a243c60f5470dce67b4e9428251dd6f8e9b4228068d42d731af184ebd39b4d513d9961bc3af79e3a855089c03c58985f4edf7f993f16b62d8eba041a4620c",
        "");
    TestBIP324PacketVector(
        223,
        ...
        "",
        true,
        "febe5b71be580a47a244ad8202f7faeb",
        "cc366d3f79d8f6cb57a7291476ebbaa1",
        "2d1af0bd851ad6e0823cfe2e26de3f683f1b80ac547c50346d3d0227519e55cf",
        "",
        "");
    TestBIP324PacketVector(
        448,
        ...
        "",
        false,
        "7c1c41f428c19ae040a8872b5e169a79",
        "9ddbfb552c89d55cb5cd34b112682c89",
        "9f4d6e6b2bebd610e9602adacae79f8a330e28329346a6a9c430c5090c0affbf",
        "",
        "");
    TestBIP324PacketVector(
        673,
        ...
        "",
        false,
        "1b62c2fa841287e365ea41085e4a9b2e",
        "1227b9f4b0e0c141e3c6ee3a5f9015bb",
        "ee9d138249d7b0c89fd594248dbae75cd7b6b01dbe98cf902086c658d60c220f",
        "",
        "");
    TestBIP324PacketVector(
        1024,
        ...
        "",
        true,
        "307cbe5b25ad27e22b5c152707c22bae",
        "f6cd5fec2a4a112ed8b27422eda7ee84",
        "523669f8252a54e96a16597fcf0695ddbc0f7987a0cbdb5e3d5085019832b6d2",
        "",
        "");
}
