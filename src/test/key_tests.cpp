...
static const std::string strSecret1 = "7K7To7Lva5S5Bw8SUAzQ2unMax4TSCThZqovRcWWrfgj7g9iSZS";
static const std::string strSecret2 = "7KJdpKWXC8TAw2qAD6Z25u8tojTHnon352gfwZ3pAofUwE83XAe";
static const std::string strSecret1C = "UrwXGWzwSzZfVFuqQw6LfRyBrr2FgDar3xS6odjGnDkLt67b9LK9";
static const std::string strSecret2C = "UsnqVrhJG7tWqV5ZePWKnd7qfGP37BTn8nS6snTRCGxrHvV7w4C8";
static const std::string addr1 = "BS2ur5ba3CkVSzbf1hp7jS563w8THrUyVu";
static const std::string addr2 = "BRRBFjiQgyiD8BBXNcPL6yDMfPikBTxeok";
static const std::string addr1C = "B6huiWsHrviPrVUgxaLrWGYrvn9hq2o5NN";
static const std::string addr2C = "BQZaptPgVGvJyHivPqfmw9E79skkgsuyvb";
...
BOOST_AUTO_TEST_CASE(key_test1)
{
    ...
    BOOST_TEST_MESSAGE("detsig: " << HexStr(detsig));
    BOOST_CHECK(detsig == ParseHex("304402204265ede8c3a38658bf2eba8d514c704c74e9bac8980641c817ee24dca6cd70fb0220322e38d6ae6009b8add8de9fe08046dfcfef94e448c2cc87785fa56469b4a627"));
    BOOST_CHECK(key2.Sign(hashMsg, detsig));
    BOOST_CHECK(key2C.Sign(hashMsg, detsigc));
    BOOST_CHECK(detsig == detsigc);
    BOOST_TEST_MESSAGE("detsig: " << HexStr(detsig));
    BOOST_CHECK(detsig == ParseHex("304402204d82905b3aaef6c4842b08dc4baaa728f15feaf58e37a0c272694c6e0070113f022066d17660a5030f46aebfba991894bcbb554d2df9fa2c3c508723e86a1bd0f7ba"));
    BOOST_CHECK(key1.SignCompact(hashMsg, detsig));
    BOOST_CHECK(key1C.SignCompact(hashMsg, detsigc));
    BOOST_TEST_MESSAGE("detsig: " << HexStr(detsig));
    BOOST_CHECK(detsig == ParseHex("1c4265ede8c3a38658bf2eba8d514c704c74e9bac8980641c817ee24dca6cd70fb322e38d6ae6009b8add8de9fe08046dfcfef94e448c2cc87785fa56469b4a627"));
    BOOST_TEST_MESSAGE("detsigc: " << HexStr(detsigc));
    BOOST_CHECK(detsigc == ParseHex("204265ede8c3a38658bf2eba8d514c704c74e9bac8980641c817ee24dca6cd70fb322e38d6ae6009b8add8de9fe08046dfcfef94e448c2cc87785fa56469b4a627"));
    BOOST_CHECK(key2.SignCompact(hashMsg, detsig));
    BOOST_CHECK(key2C.SignCompact(hashMsg, detsigc));
    BOOST_TEST_MESSAGE("detsig: " << HexStr(detsig));
    BOOST_CHECK(detsig == ParseHex("1c4d82905b3aaef6c4842b08dc4baaa728f15feaf58e37a0c272694c6e0070113f66d17660a5030f46aebfba991894bcbb554d2df9fa2c3c508723e86a1bd0f7ba"));
    BOOST_TEST_MESSAGE("detsigc: " << HexStr(detsigc));
    BOOST_CHECK(detsigc == ParseHex("204d82905b3aaef6c4842b08dc4baaa728f15feaf58e37a0c272694c6e0070113f66d17660a5030f46aebfba991894bcbb554d2df9fa2c3c508723e86a1bd0f7ba"));
}
