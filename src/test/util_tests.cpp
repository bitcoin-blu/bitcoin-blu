...
BOOST_AUTO_TEST_CASE(message_sign)
{
    ...
    const std::string expected_signature =
        "IAsLyej6FiNq7MH7HWm8UT5D97mlY8EGDi/kxY426+KTCv0XEEDayntiSu2+sF2sGt68NJ4/y5GtXYTLCFrj+W8=";
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "bea7SpbyD8XtWWSzpqxL5UvXWsh4AhDGCW",
            "signature should be irrelevant",
            "message too"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "BQHTDGSpEqncnrufQyTjWLYUXSitKz7Z3N",
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "BEV7eGMiUZo3U34cVJ9NSjrFrVnfUAqxKR",
            "H7Bk0Cj2FrBBOUYUDRrDMrVfpH2IcTnc8vGCBbjtlkg4T/8QYp50Q8Jis/qc8WywGJx1lcCon5VEd27AwThdMtU=",
            "Trust no one"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "BEV7eGMiUZo3U34cVJ9NSjrFrVnfUAqxKR",
            "IIaM+MgcfEcrCw4hQF+q09XkkAQYdHcOAAzfRNN5qowpSlTgofyehBy9sMkqzuBG899gm5SK7ZkIK1ioY0s2z2o=",
            "Trust me"),
        MessageVerificationResult::OK);
}
