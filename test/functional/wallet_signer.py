...
class WalletSignerTest(BitcoinTestFramework):
    ...
    def test_valid_signer(self):
        ...
        assert_equal(address1, "bbrt1qm90ugl4d48jv8n6e5t9ln6t9zlpm5th6qjwjtk")
        ...
        assert_equal(address4, "bbrt1phw4cgpt6cd30kz9k4wkpwm872cdvhss29jga2xpmftelhqll62msqzsn0q")
        ...
        assert_equal(address_fail, "bbrt1ql7zg7ukh3dwr25ex2zn9jse926f27xy24k0u89")
