...
BECH32_VALID = 'bbrt1qqaj8qn408432rumnffwjc9vdhst0uhrkvqa8vv'
#BECH32_VALID_UNKNOWN_WITNESS = 'bcrt1p424qxxyd0r'
BECH32_VALID_CAPITALS = 'BBRT1QGEZ85TVRHDVR5QCGNNAF7ZWUL05KA24WU0UW7P'
BECH32_VALID_MULTISIG = 'bbrt1qr5s28huv94pz6a4cluwfdggp2wfxy4ahk9zj9dfrxxq87ltemgqs3nthvx'

BECH32_INVALID_BECH32 = 'bbrt1pjcjw7ks9a6yduqj5txputvcr607fz4qd3kpuytjxngxev8tt43uqlhxy57'
BECH32_INVALID_BECH32M = 'bbrt1qjcjw7ks9a6yduqj5txputvcr607fz4qd3kpuytjxngxev8tt43uq4qxdvz'
BECH32_INVALID_VERSION = 'bbrt13jcjw7ks9a6yduqj5txputvcr607fz4qd3kpuytjxngxev8tt43uqklv2ys'
#BECH32_INVALID_SIZE = 'bbrt1pjcjw7ks9a6yduqj5txputvcr607fz4qd3kpuytjxngxev8tt43u8wwvvp2s'
#BECH32_INVALID_V0_SIZE = 'bcrt1qw508d6qejxtdg4y5r3zarvary0c5xw7kqqq5k3my'
BECH32_INVALID_PREFIX = 'xxxbc1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7k7grplx'
BECH32_TOO_LONG = 'bbrt1qqaj8qn4444444444444444444444444444444444444444444444444444444444444444408432rumnffwjc9vdhst0uhrkvqa8vv'
BECH32_ONE_ERROR = 'bbrt1qqaj8qn408432rumnffwjc9vdhst0uhrkvqa8va'
BECH32_ONE_ERROR_CAPITALS = 'BBRT1QFNCW86MSZDFFCG00JV762HU29JG4P3AYWE82E2'
BECH32_TWO_ERRORS = 'bbrt1qqaj8qn408432rumnafwjc9vdhst0uhrkvqa8va' # should be bcrt1qax9suht3qv95sw33wavx8crpxduefdrsvgsklx
BECH32_NO_SEPARATOR = 'bbrt0qqaj8qn408432rumnffwjc9vdhst0uhrkvqa8vv'
BECH32_INVALID_CHAR = 'bbrt1pjcow7ks9a6yduqj5txputvcr607fz4qd3kpuytjxngxev8tt43uq2tkg3u'
BECH32_MULTISIG_TWO_ERRORS = 'bbrt1qr5s28huv94pz6a4cluwfd22p2wfxy4ahk9zj9dfrxxq87ltemgqs3nthvx'
BECH32_MULTISIG_TWO_ERRORS = 'bbrt1qr5s28huv94pz644cluwfdggpgwfxy4ahk9zj9dfrxxq87ltemgqs3nthvx'
BECH32_WRONG_VERSION = 'bbrt1qjcjw7ks9a6yduqj5txputvcr607fz4qd3kpuytjxngxev8tt43uqqukppq'
...
class InvalidAddressErrorMessageTest(BitcoinTestFramework):
 ...
 #       self.check_invalid(BECH32_INVALID_V0_SIZE, "Invalid Bech32 v0 address program size (21 bytes), per BIP141")
         ...
         self.check_invalid(BECH32_ONE_ERROR_CAPITALS, 'Invalid Bech32 checksum', [42])
         ...
         self.check_invalid(BECH32_WRONG_VERSION, 'Invalid Bech32 checksum', [62])

        # Valid Bech32
         self.check_valid(BECH32_VALID)
         #TODO self.check_valid(BECH32_VALID_UNKNOWN_WITNESS)
 ...
 #       assert_raises_rpc_error(-5, "Invalid Bech32 address program size (41 bytes)", node.getaddressinfo, BECH32_INVALID_SIZE)
  #      assert_raises_rpc_error(-5, "Invalid or unsupported Segwit (Bech32) or Base58 encoding.", node.getaddressinfo, BECH32_INVALID_PREFIX)
   #     assert_raises_rpc_error(-5, "Invalid or unsupported Base58-encoded address.", node.getaddressinfo, BASE58_INVALID_PREFIX)
        ...
        #TODO assert "isscript" not in node.getaddressinfo(BECH32_VALID_UNKNOWN_WITNESS)
