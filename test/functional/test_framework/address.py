...
ADDRESS_BBRT1_UNSPENDABLE = 'bbrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqyaf6tq'
ADDRESS_BBRT1_UNSPENDABLE_DESCRIPTOR = 'addr(bbrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqyaf6tq)#9jarg9c0'
# Coins sent to this address can be spent with a witness stack of just OP_TRUE
ADDRESS_BBRT1_P2WSH_OP_TRUE = 'bbrt1qjcjw7ks9a6yduqj5txputvcr607fz4qd3kpuytjxngxev8tt43uqqukpfq'
...
def create_deterministic_address_bcrt1_p2tr_op_true(explicit_internal_key=None):
    ...
    if explicit_internal_key is None:
        assert_equal(address, 'bbrt1p9yfmy5h72durp7zrhlw9lf7jpwjgvwdg0jr0lqmmjtgg83266lqsvdgre0')
...
def program_to_witness(version, program, main=False):
    ...
    return encode_segwit_address("bb" if main else "bbrt", version, program)
