...
class TestFrameworkScript(unittest.TestCase):
    def test_segwit_encode_decode(self):
        def test_python_bech32(addr):
            hrp = addr[:4]
            self.assertEqual(hrp, "bbrt")
            (witver, witprog) = decode_segwit_address(hrp, addr)
            self.assertEqual(encode_segwit_address(hrp, witver, witprog), addr)

        # P2WPKH
        test_python_bech32('bbrt1qqaj8qn408432rumnffwjc9vdhst0uhrkvqa8vv')
        # P2WSH
        test_python_bech32('bbrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqyaf6tq')
        test_python_bech32('bbrt1qjcjw7ks9a6yduqj5txputvcr607fz4qd3kpuytjxngxev8tt43uqqukpfq')
        # P2TR
        test_python_bech32('bbrt1p6my3utxpm6q6gk96tyveaz8udye9t0a8wl9hwynhmhxwgw3j94rqancc22')
