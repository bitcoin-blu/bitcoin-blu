...
class WalletLabelsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if self.options.descriptors:
            ...
            #BECH32_VALID = {  BITCOIN-BLU TODO
             #   '✔️_VER15_PROG40': 'bbrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqyaf6tq',
              #  '✔️_VER16_PROG03': 'bcrt1sqqqqq8uhdgr',
               # '✔️_VER16_PROB02': 'bcrt1sqqqq4wstyw',
            #}
            BECH32_VALID = {
                '✔️_VER15_PROG40': 'bbrt1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqyaf6tq'
                #'✔️_VER16_PROG03': 'bbrt1qs4k8dfmyzzs7hy807n', BITCOIN-BLU TODO
                #'✔️_VER16_PROB02': 'bcrt1sqqqq4wstyw',  BITCOIN-BLU TODO
            }
            BECH32_INVALID = {
