...
class WalletHDTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("BITCOIN_BLU *_*_*_*_*_*_*_*_*_*_*_*")
        # self.log.info(change_addrV)
        self.log.info(change_addrV["address"])
        self.log.info(change_addrV["hdkeypath"])
        ...
        non_hd_add = 'bbrt1q4uv63lk2rx57wrwfh328jurldddmv234wxus9d'
        # non_hd_add = 'bcrt1qmevj8zfx0wdvp05cqwkmr6mxkfx60yezwjksmt'
        non_hd_key = 'tprv8jgDAweF9H9yx1vdyCRWMC6yukUaYx9Ri7KVQFzEFq47X8MBEoPTg6o9Qo6ETcjpfdwJyJeVdf4hzLWLmcepxHcxCR45YXf536kDDAhbCbV'
