...
class ExampleTest(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        self.log.info("-------------------------------")
        self.log.info("Setup the test network topology")
        self.log.info("-------------------------------")
        ...
        self.log.info("sync nodes --> nodes synced")
    ...
    def run_test(self):
        """Main test logic"""
        self.log.info("Main test logic")

        self.log.info("add_p2p_connection...")
        # Create P2P connections will wait for a verack to make sure the connection is fully up
        peer_messaging = self.nodes[0].add_p2p_connection(BaseNode())

        self.log.info("add_p2p_connection ... done")
