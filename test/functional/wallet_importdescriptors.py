...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        xpriv = "tprv8ZgxMBicQKsPf9k5k82kzhVcSmrPiq1ymUvaZPjzriqf9i3KnjaoifoQGAwcE4bWhbRgMTCF7BDqxktgTwvEAGhUXQpijWEEkE6L41PNwrJ"
        xpub = "tpubD6NzVbkrYhZ4YcmsdmhMQ79j1oNKtACtLnXMqunJGze3zCJ6R8QPuARGSHSCcMYs2jinNVZZPCgJcS9GN2CXJsksS8aYXNDaZmJ9rjdq3Fg"
        addresses = ["mrao62BinrkiutHyYpZhEhg63cUmBasaAu", "mvmfWoGYdRoXtWh6Feotgz9BCPeH21emSR"] # hdkeypath=m/0'/0'/0' and 1'
        addresses += ["bbrt1q35gz3zgpy4gkqhgmwmsc767ee7j7nzzgmyajek", "bbrt1q8rp46u7tr4r6kpu6f9yu7n2yj6x3nx9nsq9n6y"] # wpkh subscripts corresponding to the above addresses
        ...
        addresses = [
            'bbrt1qtmp74ayg7p24uslctssvjm06q5phz4yrpgrnlj', # m/0'/0'/0
            'bbrt1q8vprchan07gzagd5e6v9wd7azyucksq2pv9p6e', # m/0'/0'/1
            'bbrt1qtuqdtha7zmqgcrr26n2rqxztv5y8rafjx3y8nz', # m/0'/0'/2
            'bbrt1qau64272ymawq26t90md6an0ps99qkrsennqpe3', # m/0'/0'/3
            'bbrt1qsg97266hrh6cpmutqen8s4s962aryy77445jy3', # m/0'/0'/4
        ]
        ...
        assert_equal(addr, 'bbrt1qdt0qy5p7dzhxzmegnn4ulzhard33s2809arjqgjndx87rv5vd0fqlrh5t4') # Derived at m/84'/0'/0'/0
        change_addr = wmulti_priv.getrawchangeaddress('bech32') # uses change 0
        assert_equal(change_addr, 'bbrt1qt9uhe3a9hnq7vajl7a094z4s3crm9ttf8zw3f5v9gr2nyd7e3lns3wqsgt') # Derived at m/84'/1'/0'/0
        ...
        assert_equal(addr, 'bbrt1qp8s25ckjl7gr6x2q3dx3tn2pytwp05upkjztk6ey857tt50r5aeqxpw0vh') # Derived at m/84'/0'/0'/1
        change_addr = wmulti_pub.getrawchangeaddress('bech32') # uses change 2
        assert_equal(change_addr, 'bbrt1qp6j3jw8yetefte7kw6v5pc89rkgakzy98p6gf7ayslaveaxqyjusx4pyq2') # Derived at m/84'/1'/0'/2
