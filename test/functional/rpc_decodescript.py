...
class DecodeScriptTest(BitcoinTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        print("SHORT TEST _*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_")
        print(rpc_result['address'])
        assert_equal('bbrt1pfeeswmrmrv', rpc_result['address'])
    ...
    def decodescript_datadriven_tests(self):
        ...
        for script, result in dd_tests:
            ...
            print("DECODE SCRIPT *_*_*_*_*_*_*_*_*_*_*_*_*_*")
            print("result-----------------------------")
            print(result)
            print("rpcresult--------------------------")
            print(rpc_result)
    ...
    def decodescript_miniscript(self):
        ...
        print("TEST *_*_*_*_*_**__**_*_*_*_*_*_*_**_*_*_")
        print(res["segwit"]["desc"])

        assert res["segwit"]["desc"] == "addr(bbrt1q73qyfypp47hvgnkjqnav0j3k2lq3v76wg22dk8tmwuz5sfgv66xseaaenw)#qphj488q"
