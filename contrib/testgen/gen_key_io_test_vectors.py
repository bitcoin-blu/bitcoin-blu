...
bech32_templates = [
  ...
  ('bb',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('bb',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('bb',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('bb',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tt',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tt',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tt',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tt',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tt',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tt',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tt',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tt',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('bbrt',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('bbrt',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('bbrt',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('bbrt', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tt',   17, 32, Encoding.BECH32M, False, False, False),
  ('bbrt',  3,  1, Encoding.BECH32M, False, False, False),
  ('bb',   15, 41, Encoding.BECH32M, False, False, False),
  ('tt',    0, 16, Encoding.BECH32,  False, False, False),
  ('bbrt',  0, 32, Encoding.BECH32,  True,  False, False),
  ('bb',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tt',    0, 32, Encoding.BECH32,  False, True,  False),
  ('bbrt',  0, 20, Encoding.BECH32,  False, False, True),
  ('bb',    0, 20, Encoding.BECH32M, False, False, False),
  ('tt',    0, 32, Encoding.BECH32M, False, False, False),
  ('bbrt',  0, 20, Encoding.BECH32M, False, False, False),
  ('bb',    1, 32, Encoding.BECH32,  False, False, False),
  ('tt',    2, 16, Encoding.BECH32,  False, False, False),
  ('bbrt', 16, 20, Encoding.BECH32,  False, False, False),
]
