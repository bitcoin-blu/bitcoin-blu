...
Add these lines to your `/etc/tor/torrc` (or equivalent config file):
    ...
    HiddenServicePort 8343 127.0.0.1:8344

The directory can be different of course, but virtual port numbers should be equal to
your bitcoind's P2P listen port (8343 by default), and target addresses and ports
should be equal to binding address and port for inbound Tor connections (127.0.0.1:8344 by default).
...
your address. To mitigate this, additionally bind the address of your Tor proxy:
    ...
    ./bitcoind ... -bind=127.0.0.1:8344=onion
...
and open port 8343 on your firewall (or use port mapping, i.e., `-upnp` or `-natpmp`).
